...
const AdventureLoader = ({ children, forceLoading = null }) => {
  ...
  // If forceLoading is provided, follow that. Otherwise, follow the timer.
  const isCurrentlyLoading = forceLoading !== null ? forceLoading : internalLoading;
return (
    <>
      <AnimatePresence>
        {isCurrentlyLoading && (
